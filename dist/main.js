...
createNewProjectForm.addEventListener('submit', (e) => {
    e.preventDefault();
    const [title] = _projects__WEBPACK_IMPORTED_MODULE_1__.getProjectFormData(e.target);
    _projects__WEBPACK_IMPORTED_MODULE_1__.createProject(title);
    _projects__WEBPACK_IMPORTED_MODULE_1__.storeProjectsList();
    _UI__WEBPACK_IMPORTED_MODULE_0__.updateNewTaskModal();
    _UI__WEBPACK_IMPORTED_MODULE_0__.closeNewProjectModal();
    _UI__WEBPACK_IMPORTED_MODULE_0__.renderProjectCards();
});

openNewProjectModalBtn.addEventListener('click', () => {
    _UI__WEBPACK_IMPORTED_MODULE_0__.openNewProjectModal();
});
...
closeUpdateProjectModalBtn.addEventListener('click', () => {
    _UI__WEBPACK_IMPORTED_MODULE_0__.closeUpdateProjectModal();
});

openNewTaskModalBtn.addEventListener('click', () => {
    _UI__WEBPACK_IMPORTED_MODULE_0__.openNewTaskModal();
});

closeNewTaskModalBtn.addEventListener('click', () => {
    _UI__WEBPACK_IMPORTED_MODULE_0__.closeNewTaskModal();
});

closeUpdateTaskModalBtn.addEventListener('click', () => {
    _UI__WEBPACK_IMPORTED_MODULE_0__.closeUpdateTaskModal();
});

updateProjectForm.addEventListener('submit', (e) => {
    e.preventDefault();
    const [title, projectId] = _projects__WEBPACK_IMPORTED_MODULE_1__.getUpdateProjectFormData(e.target);
    _projects__WEBPACK_IMPORTED_MODULE_1__.updateProject(title, projectId);
    _projects__WEBPACK_IMPORTED_MODULE_1__.storeProjectsList();
    _UI__WEBPACK_IMPORTED_MODULE_0__.updateNewTaskModal();
    _UI__WEBPACK_IMPORTED_MODULE_0__.closeUpdateProjectModal();
    _UI__WEBPACK_IMPORTED_MODULE_0__.renderProjectCards();
...
updateTaskForm.addEventListener('submit', (e) => {
    e.preventDefault();
    const [title, dueDate, priority, taskId] = _tasks__WEBPACK_IMPORTED_MODULE_2__.getUpdateTaskFormData(
        e.target
    );
    const formattedDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(dueDate), 'MMM-dd');
    _tasks__WEBPACK_IMPORTED_MODULE_2__.updateTask(title, formattedDueDate, priority, taskId);
    _projects__WEBPACK_IMPORTED_MODULE_1__.storeProjectsList();
    _UI__WEBPACK_IMPORTED_MODULE_0__.closeUpdateTaskModal();
    _UI__WEBPACK_IMPORTED_MODULE_0__.renderTaskCards();
});

createNewTaskForm.addEventListener('submit', (e) => {
    e.preventDefault();
    const [projectId, title, dueDate, priority] = _tasks__WEBPACK_IMPORTED_MODULE_2__.getTaskFormData(
        e.target
    );
    const formattedDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(dueDate), 'MMM-dd');
    _tasks__WEBPACK_IMPORTED_MODULE_2__.createTask(projectId, title, formattedDueDate, priority);
    _projects__WEBPACK_IMPORTED_MODULE_1__.storeProjectsList();
    _UI__WEBPACK_IMPORTED_MODULE_0__.closeNewTaskModal();
    _UI__WEBPACK_IMPORTED_MODULE_0__.renderTaskCards();
});
...
projectsScroller.addEventListener('click', (e) => {
    ...
    if (e.target.id === 'openUpdateProjectModalBtn') {
        _UI__WEBPACK_IMPORTED_MODULE_0__.openUpdateProjectModal(targetProjectKey.dataset.projectkey);
    } else if (e.target.id === 'deleteProjectBtn') {
        _projects__WEBPACK_IMPORTED_MODULE_1__.deleteProject(targetProjectKey.dataset.projectkey);
        _projects__WEBPACK_IMPORTED_MODULE_1__.storeProjectsList();
        _UI__WEBPACK_IMPORTED_MODULE_0__.renderProjectCards();
    } else if (e.target.id === 'deleteTaskBtn') {
        _tasks__WEBPACK_IMPORTED_MODULE_2__.deleteTask(targetTaskKey.dataset.taskkey);
        _projects__WEBPACK_IMPORTED_MODULE_1__.storeProjectsList();
        _UI__WEBPACK_IMPORTED_MODULE_0__.renderProjectCards();
    } else if (e.target.matches('input')) {
        _tasks__WEBPACK_IMPORTED_MODULE_2__.updateCompletedStatus(targetTaskKey.dataset.taskkey);
        _projects__WEBPACK_IMPORTED_MODULE_1__.storeProjectsList();
        _UI__WEBPACK_IMPORTED_MODULE_0__.renderProjectCards();
    }
});
...
tasksContainer.addEventListener('click', (e) => {
    ...
    if (e.target.id === 'openUpdateTaskModalBtn') {
        _UI__WEBPACK_IMPORTED_MODULE_0__.openUpdateTaskModal(targetTaskKey.dataset.taskkey);
    } else if (e.target.id === 'deleteTaskBtn') {
        _tasks__WEBPACK_IMPORTED_MODULE_2__.deleteTask(targetTaskKey.dataset.taskkey);
        _projects__WEBPACK_IMPORTED_MODULE_1__.storeProjectsList();
        _UI__WEBPACK_IMPORTED_MODULE_0__.renderTaskCards();
...
nav.addEventListener('click', (e) => {
    _UI__WEBPACK_IMPORTED_MODULE_0__.renderProjectCards();
    _UI__WEBPACK_IMPORTED_MODULE_0__.renderTaskCards();
    _UI__WEBPACK_IMPORTED_MODULE_0__.toggleView(e.target);
});
...
/* harmony export */   "storeProjectsList": () => (/* binding */ storeProjectsList),
